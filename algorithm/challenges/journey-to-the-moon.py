...
class DisjoinSetsContainer(object):
    ...
    def mergeCommunities(self, newParent, oldParent):
        ...
        oldCommunity = self.communityMap.pop(oldParent)#we don't need this anymore
...
ans = 0
sumOfOldValues = 0
for com in M.communityMap:
    newValue = M.communityMap[com].size
    ans += sumOfOldValues * newValue
    sumOfOldValues += newValue
print(ans)
